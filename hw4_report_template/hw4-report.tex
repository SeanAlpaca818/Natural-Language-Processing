...
\author{Full Name \\ sz3684 \\ \url{https://github.com/SeanAlpaca818/Natural-Language-Processing}}
...
\url{https://github.com/SeanAlpaca818/Natural-Language-Processing}
...
\url{https://drive.google.com/file/d/1jOhT_Smkhhmsjae5WIvxDTsS04qi6WFk/view?usp=sharing}
...
Used Claude Code for refactoring code structure, debugging runtime errors (e.g., file path issues, OOM errors on HPC), and adding comments to clarify complex logic. All core implementations and design decisions were done by the student. \\
\hrulefill


\noindent\textbf{3. Example Prompts / Interactions} \\
1. ``Help me debug this FileNotFoundError in the evaluation loop'' \\
2. ``Refactor the checkpoint saving logic to support resume from interruption'' \\
3. ``Add comments explaining the collate function padding logic'' \\
\hrulefill
